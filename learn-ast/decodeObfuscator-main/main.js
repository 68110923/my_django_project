...
//js混淆代码读取
process.argv.length > 2 ? encodeFile = process.argv[2]: encodeFile ="/Users/lee/PycharmProjects/my_django_project/learn-ast/decodeObfuscator-main/input/demo.js";
process.argv.length > 3 ? decodeFile = process.argv[3]: decodeFile ="/Users/lee/PycharmProjects/my_django_project/learn-ast/decodeObfuscator-main/output/decodeResult.js";
...
//字面量解混淆
console.log("字面量解混淆,数字和字符串.......");

traverse(ast, simplifyLiteral);

console.log("1元表达式和逻辑表达式解混淆，其中一元表达式不包含- 和 void......");
